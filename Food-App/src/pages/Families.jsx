...
export default function Families() {
  ...
  const filtered = events.filter(
    (e) => !zip || e.zip_code?.includes(zip) || e.city?.toLowerCase().includes(zip.toLowerCase()) || e.state?.toLowerCase().includes(zip.toLowerCase()) || e.address?.toLowerCase().includes(zip.toLowerCase())
  );
