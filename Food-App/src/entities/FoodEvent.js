...
export const schema = {
  ...
  properties: {
    ...
    food_types:           { type: 'array', items: { type: 'string' }, description: 'Types of food available (produce, canned goods, etc.)' },
    is_recurring:         { type: 'boolean', description: 'Whether this event repeats regularly' },
    recurrence_pattern:   { type: 'string', description: 'How often the event recurs (e.g., weekly, monthly)' },
...
const ENDPOINT = '/entities/food-events';
